    ...
    <div className="space-y-6 py-4">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#FF5E5B] px-4 py-2 text-sm font-semibold text-on-accent transition-colors hover:bg-[#e54f4d]"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-surface-2 px-4 py-2 text-sm font-semibold text-text transition-colors hover:bg-surface-hover"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-[#003087] px-4 py-2 text-sm font-semibold text-on-accent transition-colors hover:bg-[#002070]"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
